...
const slides = [
  { src: "/images1/our-story-driven-group-miami.png", alt: { es: "Driven Group en Miami", en: "Driven Group in Miami" }, position: "center center" },
  { src: "/images1/real-estate-miami-vertical-developments.png", alt: { es: "Desarrollos verticales en Miami", en: "Vertical developments in Miami" }, position: "center center" },
  { src: "/images1/business-alliances-hero-v2.webp", alt: { es: "Alianzas estratégicas de Driven Business", en: "Driven Business strategic alliances" }, position: "center center" },
  { src: "/images1/academy-digital-learning-v1.webp", alt: { es: "Aprendizaje digital de Driven Academy", en: "Driven Academy digital learning" }, position: "center center" },
] as const;
