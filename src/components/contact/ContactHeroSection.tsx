...
import drivenGroupLogo from "../../../assets/logos/logo-dg-blanco.png";
    ...
    <header className="relative bg-white pt-16 sm:pt-20">
      <section className="relative min-h-[56svh] overflow-hidden bg-[#151515] sm:min-h-[62vh]" aria-label="Driven Group">
        ...
        <div className="relative mx-auto flex min-h-[56svh] max-w-[1440px] items-center px-7 sm:min-h-[62vh] sm:px-12 lg:px-20">
          <div className="flex w-full max-w-[19rem] items-center justify-center border border-white/15 bg-black/20 px-10 py-12 shadow-[0_28px_70px_rgba(0,0,0,.38)] backdrop-blur-[2px] sm:max-w-sm sm:px-14 sm:py-16">
            <Image src={drivenGroupLogo} alt="Driven Group" priority className="h-auto w-full max-w-[13rem] object-contain drop-shadow-[0_18px_30px_rgba(0,0,0,.7)]" />
          </div>
        </div>
      </section>
    </header>
