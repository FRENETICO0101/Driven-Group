...
export function ContactHeroSection() {
  return (
    <header className="relative bg-white pt-16 sm:pt-20">
      <section className="relative min-h-[62svh] overflow-hidden bg-[#151515] sm:min-h-[62vh]" aria-label="Driven Group">
        <Image
        ...
        <div className="relative mx-auto flex min-h-[62svh] max-w-[1440px] items-center px-7 sm:min-h-[62vh] sm:px-12 lg:px-20">
