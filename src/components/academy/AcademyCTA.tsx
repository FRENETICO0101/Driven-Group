  ...
  return (
    <section className="py-20 sm:py-24 md:py-32 px-6 sm:px-8 max-w-7xl mx-auto">
      <div className="bg-white border border-light-gray rounded-lg p-12 sm:p-16 md:p-20 text-center">
        <p className="editorial-label text-gray mb-4">STAY UPDATED</p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
          <input
            ...
            className="flex-1 px-6 py-3 border border-light-gray rounded-lg text-black placeholder-gray focus:outline-none focus:border-gray"
          />
          <button className="px-8 py-3 bg-black text-white text-sm font-semibold rounded-lg hover:bg-black transition-colors whitespace-nowrap">
            Notify Me
          </button>
        </div>
      </div>
