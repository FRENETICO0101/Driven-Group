  ...
  return (
    <section className="py-20 sm:py-24 md:py-32 border-y border-slate-200 bg-white">
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        {/* 4 Main Stats with right-aligned link */}
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-end gap-12 sm:gap-16">
          {/* Stats Grid */}
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-12 sm:gap-16 flex-1">
            {/* Total Sales Volume */}
            <div>
          ...
          {/* Additional text and link - right side */}
