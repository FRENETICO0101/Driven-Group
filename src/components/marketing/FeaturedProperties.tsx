  ...
  return (
    <section className="py-24 sm:py-28 md:py-32 max-w-7xl mx-auto px-6 sm:px-8">
      <div className="mb-16 md:mb-24 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
        <div>
          <p className="editorial-label text-gray mb-4">Featured Residences</p>
      ...
      {properties.length === 0 ? (
        <p className="text-gray text-center py-24 editorial-label">Próximamente nuevas oportunidades de inversión.</p>
      ) : (
