    ...
    <div className="p-8">
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray">Gestión de listado de propiedades premium</p>
        </div>
        <a
          href="#"
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-white/10 bg-white/5">
              ...
              <th className="px-6 py-4 text-left text-sm font-semibold text-light-gray">Ubicación</th>
              <th className="px-6 py-4 text-left text-sm font-semibold text-light-gray">Precio</th>
          ...
          <tbody>
            {[1, 2, 3, 4, 5].map((i) => (
              <tr key={i} className="border-b border-white/5 hover:bg-white/5 transition-colors">
                ...
                <td className="px-6 py-4 text-sm text-gray">Centro, Zona A</td>
      ...
      <div className="flex justify-between items-center mt-6">
        <p className="text-gray text-sm">Mostrando 1-5 de 156 propiedades</p>
        <div className="flex gap-2">
